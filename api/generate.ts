...
9. 禁止：华丽辞藻、四字成语连用、「愿你我都能…」式收尾、完美结局或彻底悲剧、宏大叙事
风格示例（仅供感受语感，禁止照抄内容）：
...
【正文】100-150字，第二人称「你」叙述。开头第一句必须承接上一幕最后的地点、人物或动作，并自然交代时间过去了多久，再进入这个选择带来的新境遇；不得把上一幕当作没发生，也不要重复之前幕的桥段。优先从最近几幕回收一个已经出现过的物件、声音、气味、动作或一句话，让它在新选择后产生细微变化；不要每幕都新造抒情意象。结尾再次留下一个自然的岔路口
